...
void ImageComputer::initResources()
{
...
void ImageComputer::initSwapChainResources() {
}

void ImageComputer::releaseSwapChainResources()
{
}

void ImageComputer::releaseResources() {
	vk::Device device = window_->device();
}

void ImageComputer::startNextFrame() {
}

QImage ImageComputer::generateImage(QSize size)
{
	vk::Device device = window_->device();
	...
	shaderInfo.codeSize = sizeof(image_comp);
	shaderInfo.pCode = image_comp;
