...
InstancingRenderer::InstancingRenderer(QVulkanWindow* window)
	:window_(window)
{
...
void InstancingRenderer::initResources()
{
	...
	shaderInfo.codeSize = sizeof(triangles_vert);
	shaderInfo.pCode = triangles_vert;
	vk::ShaderModule vertShader = device.createShaderModule(shaderInfo);

	shaderInfo.codeSize = sizeof(triangles_frag);
	shaderInfo.pCode = triangles_frag;
...
void InstancingRenderer::initSwapChainResources()
{
}

void InstancingRenderer::releaseSwapChainResources()
{
}

void InstancingRenderer::releaseResources() {
	vk::Device device = window_->device();
...
void InstancingRenderer::startNextFrame() {
	vk::Device device = window_->device();
