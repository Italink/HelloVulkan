...
MRTRenderer::MRTRenderer(QVulkanWindow* window)
	:window_(window) {
}

void MRTRenderer::initResources() {
...
void MRTRenderer::initSwapChainResources()
{
}

void MRTRenderer::releaseSwapChainResources()
{
}

void MRTRenderer::releaseResources() {
}

void MRTRenderer::startNextFrame() {
}

QVector<QImage> MRTRenderer::createImages(QSize size, QVector<QColor> colors)
{
	if (colors.isEmpty())
		return {};
