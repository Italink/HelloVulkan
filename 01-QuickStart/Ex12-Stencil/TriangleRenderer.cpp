...
void TriangleRenderer::initResources()
{
	...
	DSState.back.depthFailOp = vk::StencilOp::eKeep;
	DSState.back.failOp = vk::StencilOp::eKeep;
	DSState.back.passOp = vk::StencilOp::eReplace;
	DSState.back.compareMask = 0xff;
	DSState.back.writeMask = 0xff;
	DSState.back.reference = 1;
	...
	DSState.back.compareOp = vk::CompareOp::eNotEqual;
	DSState.front.compareOp = vk::CompareOp::eNotEqual;
