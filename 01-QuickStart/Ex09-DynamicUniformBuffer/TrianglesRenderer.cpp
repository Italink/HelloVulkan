...
TrianglesRenderer::TrianglesRenderer(QVulkanWindow* window)
	:window_(window)
{
...
void TrianglesRenderer::initResources()
{
...
void TrianglesRenderer::initSwapChainResources()
{
}

void TrianglesRenderer::releaseSwapChainResources()
{
}

void TrianglesRenderer::releaseResources() {
	vk::Device device = window_->device();
...
void TrianglesRenderer::startNextFrame() {
	vk::Device device = window_->device();
