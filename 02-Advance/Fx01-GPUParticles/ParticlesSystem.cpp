...
ParticleSystem::ParticleSystem(VulkanRenderer* window) : renderer_(window)
{
}
...
void ParticleSystem::initResource()
{
	...
	vk::ShaderModule computeShaderModule = renderer_->loadShader("particle_runner_comp.spv");
	...
	vk::ShaderModule vertShader = renderer_->loadShader("./particle_renderer_vert.spv");
	vk::ShaderModule fragShader = renderer_->loadShader("./particle_renderer_frag.spv");
